...
# Declare Model --->
# get model
import make_splinemodel_3Reg # generates model.apm version of the model in model.py
from make_splinemodel_3Reg import xi
from make_splinemodel_3Reg import eta
from make_splinemodel_3Reg import theta
