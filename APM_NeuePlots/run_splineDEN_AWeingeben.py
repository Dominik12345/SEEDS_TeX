...
# Declare Model --->
# get model
import make_splinemodel_AWeingeben # generates model.apm version of the model in model.py
from make_splinemodel_AWeingeben import xi
from make_splinemodel_AWeingeben import eta
from make_splinemodel_AWeingeben import theta
